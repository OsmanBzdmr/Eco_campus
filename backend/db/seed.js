...
async function seedDemoData(db) {
  ...
  await db.query(
    ...
    ['Kullanılmış Laptop', 500, 'Dell laptop, çalışıyor', 'https://placehold.co/300x300.png', userId, cats[1], 'active']
  );
  await db.query(
    'INSERT INTO products (title, price, description, image_url, user_id, category_id, status) VALUES ($1, $2, $3, $4, $5, $6, $7)',
    ['Bağış: Fizik Ders Notları', 0, 'Bedava dağıtılıyor', 'https://placehold.co/300x300.png', userId, cats[0], 'active']
  );
  await db.query(
    'INSERT INTO products (title, price, description, image_url, user_id, category_id, status) VALUES ($1, $2, $3, $4, $5, $6, $7)',
    ['USB Kablo', 25, 'Type-C kablo', 'https://placehold.co/300x300.png', userId, cats[1], 'reserved']
  );
  await db.query(
    'INSERT INTO products (title, price, description, image_url, user_id, category_id, status) VALUES ($1, $2, $3, $4, $5, $6, $7)',
    ['İstatistik Kitabı', 60, 'Yeni gibi, 2. baskı', 'https://placehold.co/300x300.png', userId, cats[0], 'active']
  );
  await db.query(
    'INSERT INTO products (title, price, description, image_url, user_id, category_id, status) VALUES ($1, $2, $3, $4, $5, $6, $7)',
    ['Kamp Masası', 150, 'Hafif ve katlanabilir', 'https://placehold.co/300x300.png', userId, cats[2], 'active']
  );
  await db.query(
    'INSERT INTO products (title, price, description, image_url, user_id, category_id, status) VALUES ($1, $2, $3, $4, $5, $6, $7)',
    ['iPhone Şarj Aleti', 0, 'İhtiyacı olana ücretsiz', 'https://placehold.co/300x300.png', userId, cats[1], 'active']
  );
  await db.query(
    'INSERT INTO products (title, price, description, image_url, user_id, category_id, status) VALUES ($1, $2, $3, $4, $5, $6, $7)',
    ['Tükenmez Kalem Seti', 0, '5 adet renkli kalem', 'https://placehold.co/300x300.png', userId, cats[0], 'active']
  );
  await db.query(
    'INSERT INTO products (title, price, description, image_url, user_id, category_id, status) VALUES ($1, $2, $3, $4, $5, $6, $7)',
    ['Monitör', 800, '27 inç IPS panel', 'https://placehold.co/300x300.png', userId, cats[1], 'active']
  );
  await db.query(
    'INSERT INTO products (title, price, description, image_url, user_id, category_id, status) VALUES ($1, $2, $3, $4, $5, $6, $7)',
    ['Çalışma Masası', 200, 'Ayarlanabilir yükseklik', 'https://placehold.co/300x300.png', userId, cats[2], 'sold']
  );
  await db.query(
    'INSERT INTO products (title, price, description, image_url, user_id, category_id, status) VALUES ($1, $2, $3, $4, $5, $6, $7)',
    ['C# Ders Notları', 45, 'I. dönem ders notları', 'https://placehold.co/300x300.png', userId, cats[0], 'active']
  );
}
